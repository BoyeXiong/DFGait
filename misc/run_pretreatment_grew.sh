...
python pretreatment_grew_probe.py --input_path "/GREW" --output_path "/GREW-64-44-pkl" --img_h 64 --img_w 44robe.py --input_path "/data/xjb/database/GREW" --output_path "/data/xjb/database/GREW/GREW-64-44-pkl" --img_h 64 --img_w 44